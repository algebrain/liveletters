...
(defn settings-dto [backend-response]
  {:nickname (:nickname backend-response)
   ...
   :smtp-security (:smtp_security backend-response)
   ...
   :imap-security (:imap_security backend-response)
...
(defn save-settings-request [form]
  {:nickname (:nickname form)
   ...
   :smtp-security (:smtp-security form)
   ...
   :imap-security (:imap-security form)
